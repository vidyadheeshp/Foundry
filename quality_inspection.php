  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Quality Inspection</li>
      </ol>
    </section>
              ...
              <div class="box-body no-padding">
                <table class="table table-responsive table-bordered">
                  ...
                  <tbody>
                    <?php 
                    $i = 1;
                    $quality_insp_query = "SELECT 
                                            qim.*
                                            ,mdt.defect_name AS defect_name
                                          FROM quality_inspection_master qim
                                          INNER JOIN meta_defect_type mdt ON mdt.sno=qim.defects 
                                          WHERE 1=1";
                    $quality_insp_result = db_all($quality_insp_query);
                    $quality_str = "";
                    foreach($quality_insp_result AS $qi){
                      $quality_str .="<tr>
                                      <td>".$i."</td>
                                      <td>".$qi['product_id']."</td>
                                      <td>".$qi['casting_weight']."</td>
                                      <td>".$qi['defect_name']."</td>
                                      <td>".$qi['location']."</td>
                                    </tr>";
                                    $i++;
                    }
